...
if (mw.config.get('wgAction') === 'view' && mw.config.get('wgIsArticle')) {
	mw.loader.load('https://cdn.jsdelivr.net/gh/Kcx36/Wikiplus-highlight@1.0/Gadget-Wikiplus.js');
	if (!('ontouchstart' in document)) {
		...
		mw.loader.load('https://cdn.jsdelivr.net/gh/Kcx36/Wikiplus-highlight@1.0/Gadget-Wikiplus-highlight.js');
	}
}
